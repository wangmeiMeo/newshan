...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Global__ = __webpack_require__(3);
...
var func = {
   ...
   * 用户登录
   */
  userLogin: function userLogin(code, scene, sceneAddress) {
    return new Promise(function (resolve, reject) {
      wx.request({
   ...
   */
  getUserInfo: function getUserInfo(encryptedData, iv) {
    return new Promise(function (resolve, reject) {
      ...
      wx.request({
        ...
        data: {
          ...
          iv: iv,
          openId: __WEBPACK_IMPORTED_MODULE_0__components_Global__["a" /* default */].openId
        },
        method: "POST",
        success: function success(res) {
          resolve(res);
   ...
   * 授权后获取用户的手机号
   */
  getUserPhone: function getUserPhone(encryptedData, iv) {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  getImgAddress: function getImgAddress() {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  //获取门店信息
  findStoreList: function findStoreList() {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  //积分余额
  balance: function balance(memberId) {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  //用户注册珊珊会员
  regist: function regist(storeId) {
    return new Promise(function (resolve, reject) {
      wx.getStorage({
        key: "phone",
        success: function success(res) {
  ...
  //微众轻会员注册
  webankLogin: function webankLogin() {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  //查询券活动
  activities: function activities(limit) {
    return new Promise(function (resolve, reject) {
      wx.request({
  ...
  //领券
  couponAcquire: function couponAcquire(activityId) {
    return new Promise(function (resolve, reject) {
      wx.getStorage({
        key: 'phone',
        success: function success(res) {
  ...
  //全的详情页面
  coupondetail: function coupondetail(couponCode) {
    return new Promise(function (resolve, reject) {
      wx.getStorage({
        key: 'phone',
        success: function success(res) {
  ...
  //memberId
  //phone
  getUserMessage: function getUserMessage(code) {
    return new Promise(function (resolve, reject) {
      wx.request({
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  scene: scene, //码参数
  sceneAddress: sceneAddress, //场景址
  token: token, //token
  memberId: memberId, //会员号
  unionId: unionId,
  flag: flag, //标识
  storename: storename //首页显示的门店的地址
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24), __webpack_require__(7)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_Global_vue__ = __webpack_require__(15);
var disposed = false
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-330ea8dc", Component.options)
  } else {
    hotAPI.reload("data-v-330ea8dc", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__barcode__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__barcode___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__barcode__);
...
function barc(id, code, width, height) {
  __WEBPACK_IMPORTED_MODULE_0__barcode___default.a.code128(wx.createCanvasContext(id), code, convert_length(width), convert_length(height));
}
...
module.exports = __webpack_require__.p + "static/img/iconcoupon.png";
...
module.exports = __webpack_require__.p + "static/img/coulogo_01.jpg";
